        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-4" style="border-radius: 20px; background: linear-gradient(135deg, #1a5d45 0%, #0f3b2c 100%);">
                <div class="text-white">
                    ...
                    <p class="mb-0 opacity-75">Halo, {{ $nama }}. Pantau statistik dan aktivitas sanggar hari ini.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                <div class="card-header bg-white border-0 p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        {{-- Menggunakan URL manual agar tidak error RouteNotFound --}}
                        <a href="{{ url('/kelas') }}" class="btn btn-sm btn-outline-primary rounded-pill px-3">Lihat Semua</a>
                    </div>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-light text-secondary border">{{ $k->kategori ?? 'Umum' }}</span></td>
                                    <td class="text-center">
                                        {{-- Menggunakan URL manual --}}
                                        <a href="{{ url('/kelas/'.$k->id_kelas.'/edit') }}" class="btn btn-sm btn-light rounded-circle">
                                ...
                                <tr>
                                    <td colspan="3" class="text-center py-5 text-muted">
                                        <i class="fa fa-folder-open fa-2x mb-3 opacity-25"></i>
